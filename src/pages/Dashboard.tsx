...
// Custom Tooltip component for Age & Gender chart
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-sm">
        <p className="text-sm font-medium text-gray-900">{`Age Range: ${label}`}</p>
...
// Custom Tooltip for Attrition Trends
const AttritionTrendsTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-sm">
...
// Custom Tooltip for Department Risk
const DepartmentRiskTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-sm">
...
// Custom Tooltip for Primary Risk Factors
const PrimaryRiskFactorsTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-sm">
        {payload.map((entry, index) => (
...
export default function Dashboard() {
  ...
  const [employeeRiskPercentageChange, setEmployeeRiskPercentageChange] = useState(0);
  const [employeeRententionStats, setEmployeeRententionStats] = useState(0);
  const [employeeReplacementCostStats, setEmployeeReplacementCostStats] = useState(0);
    ...
    fetch("http://127.0.0.1:8000/analytics/risk_curve_data")
      ...
      .then((data) => {
        ...
        data.forEach((item) => {
          ...
          const roundedPercentage = Number(item.Attrition_Percentage).toFixed(2);
          grouped[range][gender] += Number(roundedPercentage) || 1;
        });
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">1,471</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{employeeRiskStats}</h3>
        ...
        {/* <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{employeeRententionStats}%</h3>
              <p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                <TrendingUp className="h-3 w-3" />
                +1.8% vs industry avg
              </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm text-gray-500 hover:text-gray-700" aria-label="Filter department risk">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={departmentData}>
                ...
                <Tooltip content={<DepartmentRiskTooltip />} />
                <Legend />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip content={<PrimaryRiskFactorsTooltip />} />
                <Legend />
              </PieChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm text-gray-500 hover:text-gray-700" aria-label="Filter attrition trends">
              <span className="sr-only">Filter</span>
              <Filter className="h-4 w-4" />
            </button>
          </div>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={attritionTrends}>
                ...
                <XAxis dataKey="month" />
                <YAxis />
                <Tooltip content={<AttritionTrendsTooltip />} />
                <Legend />
          ...
          <div className="space-y-4">
            {topEmployees.length > 0 ? (
              topEmployees.map((employee) => (
                <div
                  key={employee.OriginalEmployeeNumber}
                  ...
                  <div className="flex items-center justify-between mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          ...
                          <ul className="list-disc list-inside ml-2">
                            {employee.Top_Contributing_Factors.map((factor, factorIndex) => (
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium text-red-600">
                        {employee.Attrition_Risk_Percentage.toFixed(2)}% Risk
                      </div>
                  ...
                  <div className="mt-3">
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div
                        ...
                        style={{ width: `${employee.Attrition_Risk_Percentage.toFixed(2)}%` }}
                      />
                    </div>
                  </div>
                </div>
            ...
            <button
              ...
              aria-label="View all high risk employees"
            >
              ...
              >
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
                  ...
                  <button
                    ...
                    aria-label={`Implement ${strategy.title} strategy`}
                  >
                    Implement Strategy
                  </button>
                </div>
